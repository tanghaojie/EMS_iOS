...
class WarningListTableViewCell: UITableViewCell {
...
extension WarningListTableViewCell {
    ...
    private func setupFullView() {
        fullView = UIView(frame: CGRect(x: 0, y: 0, width: WarningListTableViewCell.width, height: WarningListTableViewCell.height))
    ...
    private func setupItemView() {
        ...
        let w = fvW - WarningListTableViewCell.paddingLeft - WarningListTableViewCell.paddingRight
        let h = fvH - WarningListTableViewCell.paddingTop - WarningListTableViewCell.paddingBottom
        itemView = UIView(frame: CGRect(x: WarningListTableViewCell.paddingLeft, y: WarningListTableViewCell.paddingTop, width: w, height: h))
    ...
    private func setupTopView() {
        ...
        topView = UIView(frame: CGRect(x: 0, y: 0, width: ivW, height: WarningListTableViewCell.topViewHeight))
    ...
    private func setupTopViewContentView() {
        ...
        let w = tvW - WarningListTableViewCell.topViewContentViewPaddingLeft - WarningListTableViewCell.topViewContentViewPaddingRight
        let h = tvH - WarningListTableViewCell.topViewContentViewPaddingTop - WarningListTableViewCell.topViewContentViewPaddingBottom
        topViewContentView = UIView(frame: CGRect(x: WarningListTableViewCell.topViewContentViewPaddingLeft, y: WarningListTableViewCell.topViewContentViewPaddingTop, width: w, height: h))
    ...
    private func setupBottomView() {
        ...
        let y = ivH - WarningListTableViewCell.bottomViewHeight
        bottomView = UIView(frame: CGRect(x: 0, y: y, width: ivW, height: WarningListTableViewCell.bottomViewHeight))
    ...
    private func setupBottomViewContent() {
        ...
        let w = bvW - WarningListTableViewCell.bottomViewContentViewPaddingLeft - WarningListTableViewCell.bottomViewContentViewPaddingRight
        let h = bvH - WarningListTableViewCell.bottomViewContentViewPaddingTop - WarningListTableViewCell.bottomViewContentViewPaddingBottom
        bottomViewContentView = UIView(frame: CGRect(x: WarningListTableViewCell.bottomViewContentViewPaddingLeft, y: WarningListTableViewCell.bottomViewContentViewPaddingTop, width: w, height: h))
    ...
    private func setupMainViewContentView() {
        ...
        let w = mvW - WarningListTableViewCell.mainViewContentViewPaddingLeft - WarningListTableViewCell.mainViewContentViewPaddingRight
        let h = mvH - WarningListTableViewCell.mainViewContentViewPaddingTop - WarningListTableViewCell.mainViewContentViewPaddingBottom
        mainViewContentView = UIView(frame: CGRect(x: WarningListTableViewCell.mainViewContentViewPaddingLeft, y: WarningListTableViewCell.mainViewContentViewPaddingTop, width: w, height: h))
    ...
    private func setupMainViewContentViewTopView() {
        ...
        mainViewContentViewTopView = UIView(frame: CGRect(x: 0, y: 0, width: mvcvW, height: WarningListTableViewCell.mainViewContentViewTopHeight))
    ...
    private func setupMainViewContentViewTopView_3SubView() {
        ...
        let subViewW = tW / 3
        mainViewContentViewTopView_1Per3View = UIView(frame: CGRect(x: 0, y: 0, width: subViewW, height: tH))
        mainViewContentViewTopView_2Per3View = UIView(frame: CGRect(x: subViewW, y: 0, width: subViewW, height: tH))
...
extension WarningListTableViewCell {
    func set(vm: WarningListTableViewCellVM) {
